...
export default function SignupPage() {
  ...
  return (
    <>
      <Head>
        <title>Sign up | Project Hub</title>
      </Head>
        ...
        <div className="bg-black border-2 border-cyan-500/30 p-8 max-w-md w-full relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 border-2 border-cyan-500/50 relative mb-6">
              ...
              <User className="w-10 h-10 text-cyan-400 relative z-10" />
            </div>
            <h1 className="text-2xl font-black text-white tracking-[0.2em] uppercase">Sign up</h1>
            <p className="text-cyan-400/50 text-xs mt-2 tracking-widest uppercase">Create your account</p>
          </div>
